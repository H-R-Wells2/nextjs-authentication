    ...
    <main className="min-h-[100dvh] bg-slate-100 py-12 flex flex-col items-center justify-center px-4 sm:pt-20 relative">
      <div className="text-center">
        ...
        <div className="mt-6">
          <Link
            href="/"
            className="inline-block rounded bg-secondary px-6 py-3 text-white text-sm font-medium shadow hover:bg-[#13aa95] focus:outline-none focus:ring-2 focus:ring-secondary"
          >
            Go back home
          </Link>
        </div>
