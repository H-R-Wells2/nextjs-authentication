  ...
  return (
    <div className="">
      {session ? (
        ...
        >
          <button className="w-full flex items-center justify-center gap-2 border border-slate-300 hover:bg-slate-100 transition-colors rounded-lg px-3 py-1.5 font-medium text-slate-700 bg-white cursor-pointer shadow-md">
